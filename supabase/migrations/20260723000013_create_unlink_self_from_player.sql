...
-- symmetric with create_link_self_to_player.sql's own squash note. Earlier
-- versions of this function also had to unlink a Championship-flight
-- "sibling" row; that block is gone along with the duplicated-row shape it
-- existed to patch around.
