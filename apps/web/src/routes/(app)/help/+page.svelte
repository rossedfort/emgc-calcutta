		...
		<Accordion.Root type="multiple" class="mt-1">
			...
			<Accordion.Item value="notifications" class="border-brass/20">
				...
				<Accordion.Content class="text-ink/70">
					...
					<a href={routes.settingsNotifications()} class="font-medium text-fairway">
			...
			<Accordion.Root type="multiple" class="mt-1">
				...
				<Accordion.Item value="voids-audit" class="border-brass/20">
					...
					<Accordion.Content class="text-ink/70">
						...
						<a href={routes.adminAudit()} class="font-medium text-fairway">
							Go to the audit log →
						</a>
					</Accordion.Content>
				</Accordion.Item>
				...
				<Accordion.Item value="settling-up" class="border-brass/20">
					...
					<Accordion.Content class="text-ink/70">
						...
						<a href={routes.adminTournaments()} class="font-medium text-fairway">
							Go to tournaments →
						</a>
					</Accordion.Content>
				</Accordion.Item>
				...
				<Accordion.Item value="owner-only" class="border-brass/20">
					...
					<Accordion.Content class="text-ink/70">
						...
						<a href={routes.adminUsers()} class="font-medium text-fairway"> Go to users → </a>
					</Accordion.Content>
				</Accordion.Item>
			</Accordion.Root>
		</section>
