...
export const routes = {
	...
	adminTournamentAuctionLeadingBids: (slug: string) =>
		resolve('/(app)/admin/tournaments/[slug]/auction/leading-bids', { slug }),
	adminTournamentAuctionLiveBids: (slug: string) =>
		resolve('/(app)/admin/tournaments/[slug]/auction/live-bids', { slug }),
